...
**New role file** — complete `.md` slash command with:
...
Terse and specific. Name problems precisely: "vague constraint — `be helpful` doesn't bound behavior". Explain key design decisions briefly. No filler.
